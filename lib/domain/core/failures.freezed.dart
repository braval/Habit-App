...
class _$ValueFailureTearOff {
  ...
  NameTooLong<T> nameTooLong<T>({@required T failedValue, @required int max}) {
  ...
  DoNotMatchs<T> doNotMatch<T>() {
    return DoNotMatchs<T>();
  }
}
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required Result nameTooLong(T failedValue, int max),
    @required Result doNotMatch(),
  });
  @optionalTypeArgs
  Result maybeWhen<Result extends Object>({
    ...
    Result nameTooLong(T failedValue, int max),
    Result doNotMatch(),
  ...
  Result map<Result extends Object>({
    ...
    @required Result doNotMatch(DoNotMatchs<T> value),
  });
  @optionalTypeArgs
  Result maybeMap<Result extends Object>({
    ...
    Result doNotMatch(DoNotMatchs<T> value),
    @required Result orElse(),
  });
}
...
abstract class $NameTooLongCopyWith<T, $Res> {
  factory $NameTooLongCopyWith(
          NameTooLong<T> value, $Res Function(NameTooLong<T>) then) =
      _$NameTooLongCopyWithImpl<T, $Res>;
  $Res call({T failedValue, int max});
}

class _$NameTooLongCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $NameTooLongCopyWith<T, $Res> {
  _$NameTooLongCopyWithImpl(
      NameTooLong<T> _value, $Res Function(NameTooLong<T>) _then)
      : super(_value, (v) => _then(v as NameTooLong<T>));

  @override
  NameTooLong<T> get _value => super._value as NameTooLong<T>;
...
class _$NameTooLong<T> implements NameTooLong<T> {
  const _$NameTooLong({@required this.failedValue, @required this.max})
      : assert(failedValue != null),
        assert(max != null);
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.nameTooLong(failedValue: $failedValue, max: $max)';
  }
  ...
  @override
  $NameTooLongCopyWith<T, NameTooLong<T>> get copyWith =>
      _$NameTooLongCopyWithImpl<T, NameTooLong<T>>(this, _$identity);
  ...
  Result when<Result extends Object>({
    ...
    assert(nameTooLong != null);
    assert(doNotMatch != null);
    return nameTooLong(failedValue, max);
  }
...
abstract class NameTooLong<T> implements ValueFailure<T> {
  const factory NameTooLong({@required T failedValue, @required int max}) =
      _$NameTooLong<T>;
...
abstract class $DoNotMatchsCopyWith<T, $Res> {
  factory $DoNotMatchsCopyWith(
          DoNotMatchs<T> value, $Res Function(DoNotMatchs<T>) then) =
      _$DoNotMatchsCopyWithImpl<T, $Res>;
}

class _$DoNotMatchsCopyWithImpl<T, $Res>
    extends _$ValueFailureCopyWithImpl<T, $Res>
    implements $DoNotMatchsCopyWith<T, $Res> {
  _$DoNotMatchsCopyWithImpl(
      DoNotMatchs<T> _value, $Res Function(DoNotMatchs<T>) _then)
      : super(_value, (v) => _then(v as DoNotMatchs<T>));

  @override
  DoNotMatchs<T> get _value => super._value as DoNotMatchs<T>;
}

class _$DoNotMatchs<T> implements DoNotMatchs<T> {
  const _$DoNotMatchs();

  @override
  String toString() {
    return 'ValueFailure<$T>.doNotMatch()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) || (other is DoNotMatchs<T>);
  }
...
abstract class DoNotMatchs<T> implements ValueFailure<T> {
  const factory DoNotMatchs() = _$DoNotMatchs<T>;
}
